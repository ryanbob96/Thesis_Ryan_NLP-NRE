...
class Ui_MainWindow(object):
    def __init__(self, num_text=0, name_cage=None, path_mesh=[], path_cage=None,
...
"")
        ...
        self.mainBody.setMaximumSize(QtCore.QSize(16777215, 373))
...
"}")
        ...
        self.headerFrame.setMaximumSize(QtCore.QSize(16777215, 65))
...
#INPUT TEXT FILE
    ...
    def next_assign(self):
            self.num = self.num + 1
            self.labelFeedText.setText(str(self.num) + '. ' +self.list_text[self.num])
