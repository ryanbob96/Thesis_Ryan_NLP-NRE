...
class Ui_MainWindow(object):
    def __init__(self, num_text=0, name_gpetro=[], name_gmeth=[], name_gloc=[], name_gtime=[], path_mesh=[], path_cage=None,
                status_count_entities=0, parts_array = [], flip_mesh = None, list_text = [], iter_subdiv = None, def_vol = [],
...
"")
        ...
        self.labelFeedText.setTextInteractionFlags(
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "GeoBERT Labeller"))
...
#INPUT TEXT FILE
    ...
    def status_popup(self):
            ...
            psx.setText('Summary of Entities')
            psx.setIcon(QMessageBox.Information)
            psx.setStandardButtons(QMessageBox.Ok | QMessageBox.Close)
            psx.setInformativeText('Show Details for All Recorded Entities')
